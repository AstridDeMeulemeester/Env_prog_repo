...
def load_dataset(srcdir: str, vars = VARIABLES, gcms = GCMS, rescale=True):
...
def plot_annual_average(dataset, var, gcm = None, dstdir = None):
    """Plot the yearly average for the given variable

    Args:
        dataset: The dataset containing all data
        var: The variable to be plotted
        gcm: The GCM to be plotted. If None, this function will take the average
